...
<html lang="en">
  ...
  <body>
    <div id="root">
          ...
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div class="text-center">
                ...
                <p class="text-gray-400">Active User${((stats[0] || 0) > 1) ? "s" : ""}</p>
              </div>
              <div class="text-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p class="text-gray-400">Message${((stats[1] || 0) > 1) ? "s" : ""} Processed</p>
              </div>
              <div class="text-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p class="text-gray-400">Server${((stats[2] || 0) > 1) ? "s" : ""} Served</p>
              </div>
            </div>
          </div>
        </section>
      ...
      await puter.fs.write(`localbotify/landing-pages/${id.toString()}/style.css`, await (await fetch("/pages/landingPage/style.css")).text());
